...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://www.notion.so/1c65e314ed0d805291f0f55c6e595865', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  // Important page_id！！！Duplicate Template from  https://tanghh.notion.site/02ab3b8678004aa69e9e415905ef32a5
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID ||
    '2a15e314ed0d80eba4fee464ec79df7f,en:2a15e314ed0d80eba4fee464ec79df7f',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '华人教会三十年', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'servant', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://cnchurch30y.968188.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '华人教会', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://i69.servimg.com/u/f69/20/30/55/87/iaiue210.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  GREETING_WORDS:
    ...
    '要向他唱诗、歌颂，谈论他一切奇妙的作为。我们不将这些事向他们的子孙隐瞒，要将耶和华的美德和他的能力，并他奇妙的作为，述说给后代听。',
